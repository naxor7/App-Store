...
function removeApp(id) {
	open("http://localhost:8080/App_Store/RejectApp?window=pendingapps&id="+id, "_self")
}

function testerVerified(id) {
	open("http://localhost:8080/App_Store/TesterVerify?window=pendingapps&id="+id, "_self");
}
